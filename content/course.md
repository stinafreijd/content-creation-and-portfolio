...
Edit the values above to update the course title, term, dashboard introduction,
feedback email or booking link. Keep each value on one line and do not change
the field names on the left of the colon.
